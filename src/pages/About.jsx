...
export default function About() {
    return (
            ...
            <section className="relative overflow-hidden h-[60vh] md:h-[75vh] lg:h-[90vh] flex items-center justify-center">
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
                        About
                        <span className="bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent"> MeFieConnect</span>
                    </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-row gap-6 mt-5 text-white">
              <div>
                <FaHandshake size={70} className=" " />
              </div>
              <div className="mt-3">
                <h3>
                    Direct Connections
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              How <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">MeFieConnect</span> Works
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="text-center p-6 hover:bg-gray-750 transition-all duration-300">
              ...
              <h3 className="text-lg text-white mb-3">1. List Your Property</h3>
            ...
            <div className="text-center p-6 hover:bg-gray-750 transition-all duration-300">
              ...
              <h3 className="text-lg text-white mb-3">2. Search & Connect</h3>
              <p className="text-white text-sm leading-relaxed">
            ...
            <div className="text-center p-6 hover:bg-gray-750 transition-all duration-300">
              ...
              <h3 className="text-lg text-white mb-3">3. Secure & Move In</h3>
              <p className="text-white text-sm leading-relaxed">
      ...
      <section className="py-20 bg-gray-900"> {/* Used bg-gray-900 for a slight contrast */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            ...
            <div className="text-center md:text-left p-6 rounded-xl hover:bg-gray-750 transition-all duration-300">
              <div className="flex items-center justify-center md:justify-start mb-4">
                ...
                <h3 className="text-lg text-white">Property Verification</h3>
              </div>
              <p className="text-white text-sm leading-relaxed">
            ...
            <div className="text-center md:text-left p-6 rounded-xl hover:bg-gray-750 transition-all duration-300">
              <div className="flex items-center justify-center md:justify-start mb-4">
                ...
                <h3 className="text-lg text-white">Identity Verification</h3>
              </div>
              <p className="text-white text-sm leading-relaxed">
            ...
            <div className="text-center md:text-left p-6 rounded-xl hover:bg-gray-750 transition-all duration-300">
              <div className="flex items-center justify-center md:justify-start mb-4">
                ...
                <h3 className="text-lg text-white">Review System</h3>
              </div>
              <p className="text-white text-sm leading-relaxed">
      ...
      <section className="py-20 bg-gray-800/50"> {/* Matches the first section's background for consistency */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="text-center p-6 rounded-xl hover:bg-gray-750 transition-all duration-300">
              ...
              <h3 className="text-lg text-white mb-3">No Hidden Fees</h3>
              <p className="text-white text-sm leading-relaxed">
            ...
            <div className="text-center p-6 rounded-xl hover:bg-gray-750 transition-all duration-300">
              ...
              <h3 className="text-lg text-white mb-3">Faster Process</h3>
              <p className="text-white text-sm leading-relaxed">
            ...
            <div className="text-center p-6 rounded-xl hover:bg-gray-750 transition-all duration-300">
              ...
              <h3 className="text-lg text-white mb-3">Direct Communication</h3>
              <p className="text-white text-sm leading-relaxed">
            ...
            <div className="text-center p-6 rounded-xl hover:bg-gray-750 transition-all duration-300">
              ...
              <h3 className="text-lg text-white mb-3">Secure Platform</h3>
              <p className="text-white text-sm leading-relaxed">
      ...
      <section className="py-20 bg-gray-900"> {/* Use bg-gray-900 for contrast */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
              <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">MeFieConnect</span> by the Numbers
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center p-6">
              <p className="text-3xl font-bold  bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent mb-2">15,000+</p>
              <p className="text-sm text-white">Verified Properties</p>
            </div>

            {/* Stat 2: Happy Tenants */}
            <div className="text-center p-6">
              <p className="text-3xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent mb-2">50,000+</p>
              <p className="text-sm text-white">Happy Tenants</p>
            </div>

            {/* Stat 3: Satisfaction Rate */}
            <div className="text-center p-6">
              <p className="text-3xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent mb-2">98%</p>
              <p className="text-sm text-white">Satisfaction Rate</p>
            </div>

            {/* Stat 4: Saved in Fees */}
            <div className="text-center p-6">
              <p className="text-3xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent mb-2">$2M+</p>
              <p className="text-sm text-white">Saved in Fees</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-20 bg-gray-900 overflow-hidden flex items-center justify-center">
        {/* Video Background */}
        <video
          autoPlay
          loop
        ...
        <div className="relative z-20 text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6 leading-tight">
            Ready to Experience <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">MeFieConnect</span>?
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-white hover:bg-gray-200 text-blue-600 font-bold py-3 px-8 rounded-lg text-lg transition-all duration-300 shadow-lg">
              List Your Property
            </button>
            <Link to="/properties"><button className="bg-transparent border-2 border-white hover:bg-white hover:text-gray-800  text-blue-600 font-bold py-3 px-8 rounded-lg text-lg transition-all duration-300 shadow-lg">
              Browse Properties
            </button></Link>
          </div>
        </div>
