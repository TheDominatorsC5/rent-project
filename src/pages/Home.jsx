  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-900 font-[outfit]">
        ...
        {/* Products Section (Landlord Services) */}
        <section className="py-20"> {/* Removed specific background for consistency with other dark sections */}
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-400 max-w-3xl mx-auto">
                Comprehensive solutions for property owners, from listing to tenant management and everything in between.
              </p>
            </div>
